 ...
 * This new version can generate two independent PWM output.\n
 * \n
...
/**
 * Set output value of software DAC channel A
 *
 * @param value Analog value between 0 and 255
 */
inline void soft_dac_output_A( uint8_t value ) {
  OCR0A = value; // Set value (double buffered in Fast PWM mode to avoid glitch)
}

/**
 * Set output value of software DAC channel B
 *
 * @param value Analog value between 0 and 255
 */
inline void soft_dac_output_B( uint8_t value ) {
